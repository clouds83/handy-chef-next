...
const Action = forwardRef(
  (
    { children, variant = 'primary', size = 'md', Icon, iconRight, iconClass, className, ...props }: ActionProps,
    ref
  ) => {
    ...
    if (props.as === 'a') {
      ...
      return (
        <Link ref={ref as React.Ref<HTMLAnchorElement>} className={classes} {...rest} href={href as Url}>
          <Content />
        </Link>
      )
    }
